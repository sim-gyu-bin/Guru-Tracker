...
- `.omp/agents`의 SEC·ARK·PTR 수집, 공식 출처 조사, 프런트엔드 전문 역할과 관련 스킬을 작업 성격에 맞게 사용한다.
- 작업자에게 이 프로젝트의 공식 출처·동기화·데이터·보안 제약을 명시적으로 전달한다. 전문 역할 정의가 Herdr 페인에 자동으로 적용된다고 가정하지 않는다.
