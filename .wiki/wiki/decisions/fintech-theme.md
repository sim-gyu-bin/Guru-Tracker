...
On 2026-09-22, the user explicitly approved deleting the unused Space Grotesk font and its license after a reference audit. This supersedes only the asset-preservation decision above; the active Pretendard font, license, typography, and theme remain unchanged.
